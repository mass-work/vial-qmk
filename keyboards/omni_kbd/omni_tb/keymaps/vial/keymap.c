...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______,
          KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_LEFT,  KC_RGHT,
        MS_WHLU, MS_WHLD, MS_WHLL, MS_WHLR,   KC_UP,  KC_DOWN,
         ...
         0x770C,  0x770D,  0x770E,  0x770F,  0x7710,   0x7711,
         0x7712,  0x7713,  0x7714,  0x7715,  0x7716,   0x7717,
         0x7700,  0x7700,  0x7700,  0x7700,  _______, _______,
    ...
    [_SUB] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,      
          KC_NO,      KC_NO,      KC_NO,      KC_NO,	_______,	_______,
        MS_WHLU,    MS_WHLD,    MS_WHLL,    MS_WHLR,	_______,	_______,
        _______,	_______,	_______,	_______,	_______,	_______,
        _______,	_______,	_______,	_______,	_______,	_______,
        _______,	_______,	_______,	_______,	_______,	_______,
        _______,	_______,	_______,	_______,	_______,	_______,
    ...
    [_SYMBOL] = LAYOUT(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,
        0x7700,    0x7700,   0x7700,  _______,   0x7702,   0x7700,
        0x7700,    0x7700,   0x77FE,   0x7700,   0x7700,   0x77FE,
        0x770E,    0x773C,   0x770C,   0x7741,   0x7701,   0x7700,
        _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,
    ...
    [_CUSTOM] = LAYOUT(
        ...
        _______,   _______,  _______,  _______,  _______,   _______,
        _______,   _______,  _______,  _______,  _______,   _______,
         0x7700,    0x7701,   0x7701,   0x7701,   0x7700,    0x7700,
         0x7700,    0x7700,   0x7700,   0x7712,   0x7700,    0x7700,
         0x7700,    0x7700,   0x7700,   0x771B,   0x7700,    0x7700,
         0x7700,    0x7701,   0x7701,   0x7700,   0x7700,    0x7700,
         0x7700,    0x7700,   0x7700,   0x7712,   0x7700,    0x7700,
         0x7700,    0x7700,   0x7700,   0x771B,   0x7700,    0x7700,
        _______,   _______,  _______,  _______,  _______,   _______,
        _______,   _______,  _______,  _______,  _______,   _______,
